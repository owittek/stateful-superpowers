...
Use these terms exactly in every suggestion. Consistent language is the point — don't drift into "component," "service," "API," or "boundary." Full definitions in [LANGUAGE.md](../designing-modules/LANGUAGE.md).
...
Key principles (see [LANGUAGE.md](../designing-modules/LANGUAGE.md) for the full list):
...
**Use CONTEXT.md vocabulary for the domain, and [LANGUAGE.md](../designing-modules/LANGUAGE.md) vocabulary for the architecture.** If `CONTEXT.md` defines "Order," talk about "the Order intake module" — not "the FooBarHandler," and not "the Order service."
