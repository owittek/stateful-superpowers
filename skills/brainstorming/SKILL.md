...
- **Ask in frontier rounds** - `superpowers:grilling` owns the interview: ask every question whose prerequisites are already settled in one round, then wait. A question that depends on one still open belongs to a later round.
