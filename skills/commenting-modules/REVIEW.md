...
2. **Verified precision, not asserted precision.** For every stated bound, sentinel, ordering, or invariant, confirm it against the code and call sites:
   ...
   - any "must call X before Y" precondition is real,
