...
```bash
agy plugin install https://github.com/owittek/stateful-superpowers
```
...
- Or install directly from this repository:
  ...
  ```text
  /plugins install https://github.com/owittek/stateful-superpowers
  ```
...
```bash
pi install git:github.com/owittek/stateful-superpowers
```
